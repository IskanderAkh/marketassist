  ...
  return (
    <>
      <div className='flex min-h-96 gap-5'>
        <div className='w-full flex items-start justify-between gap-3 mt-20'>
          <div className='w-full flex flex-col justify-between h-full'>
            <div className='account-input'>
              <label className="flex items-center gap-2 text-start font-rfBold account-input-label">
                ИНН/ОГРНИП
                <input
                  type="text"
      ...
      <div className='flex gap-2 mt-20 justify-between'>
        {/* <div className='btn-gradient'> */}
          <button className='bg-custom-gradient font-rfBold text-white rounded-500 px-12 py-2.5' onClick={submitData} title='Для добавления новых данных'>
            Сохранить данные
          </button>
        {/* </div> */}
        <EditProfileModal />
